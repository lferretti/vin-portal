...
export const appConfig = registerAs('app', () => ({
  ...
  contractRateLimitTtlSeconds: parseInt(process.env.CONTRACT_RATE_LIMIT_TTL_SECONDS ?? '60', 10),
  contractRateLimitMax: parseInt(process.env.CONTRACT_RATE_LIMIT_MAX ?? '100', 10),
